...
def generate_output_filename(city, theme_name, path=POSTERS_DIR):
    """
...
def get_edge_colors_by_type(graph, theme):
    """
...
def create_poster(city, country, theme, distance):
    ...
    process_create_poster(city, country, coords, distance, output_file, theme)
